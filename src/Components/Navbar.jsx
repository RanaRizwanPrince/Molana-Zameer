        ...
        <>
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav m-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item">
                                    <NavLink className="nav-link" to="/About" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" onClick={closeNavbar}>About</NavLink>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <NavLink className="nav-link" to="/Conferences" onClick={closeNavbar}>Conferences</NavLink>
                                </li>
                                <li className="nav-item">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                ...
                <div class="offcanvas-body">
                    ...
                    <NavLink className="nav-link" to="/Biography" onClick={closeNavbar}>Zameer Biography </NavLink><hr />
