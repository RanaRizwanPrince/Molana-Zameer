            ...
            <section className="librirbookle">
                <div className="container-fluid text-center">
                    ...
                    <Swiper modules={[Autoplay]} autoplay={{ delay: 2000, disableOnInteraction: false }} loop={true} spaceBetween={20} breakpoints={{
                        ...
                        <SwiperSlide>
                            <div className="book"><img src="https://gramentheme.com/html/bookle/assets/img/book/04.png" alt="01" /></div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="book"><img src="https://gramentheme.com/html/bookle/assets/img/book/05.png" alt="01" /></div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="book"><img src="https://gramentheme.com/html/bookle/assets/img/book/03.png" alt="01" /></div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="book"><img src="https://gramentheme.com/html/bookle/assets/img/book/02.png" alt="01" /></div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="book"><img src="https://gramentheme.com/html/bookle/assets/img/book/05.png" alt="01" /></div>
                        </SwiperSlide>
